...
export default function Presentation() {
    ...
    return (
        <section id="presentation" className="gap-4 py-8 md:py-10 flex flex-col justify-center max-w-full h-screen">
            ...
            <BlindText />
            <p className={`text-lg max-w-[50%] ${DmMono.className}`}>I'm a software developer based near Barcelona, Spain, specialized in building extraordinary web solutions.</p>
        </section>
    );
}